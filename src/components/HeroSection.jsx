...
export default function HeroSection({ setActiveView }) {
  ...
  // Mouse Reactive Parallax System
    ...
    >
      ...
      <div className="container flex flex-col items-center text-center z-10" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
        ...
        >
          ...
          <span style={{ fontSize: '0.75rem', fontWeight: 500, color: 'var(--text-secondary)', letterSpacing: '0.04em' }}>
            Enterprise Commerce Engine
          </span>
        </motion.div>

        {/* Progressive Text Reveal Headline (Desktop) */}
        <h1 
          className="cf-desktop-headline max-w-4xl font-extrabold mb-6 tracking-tight leading-none"
          style={{
            maxWidth: '1000px',
        ...
        <h1 
          className="cf-mobile-headline font-extrabold mb-6 tracking-tight leading-none"
          style={{
            fontSize: '3.5rem',
            fontFamily: 'var(--font-display)',
            fontWeight: 600,
        ...
        {/* Action Button CTAs */}
        <motion.div
          className="cf-hero-ctas"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 0.75, ease: [0.16, 1, 0.3, 1] }}
          style={{ display: 'flex', gap: '16px', justifyContent: 'center', marginBottom: '46px', flexWrap: 'wrap', width: '100%', maxWidth: '440px' }}
        >
          <button 
          ...
          <a href="#features" className="btn btn-secondary" style={{ padding: '0 24px', height: '48px', fontSize: '1rem', fontWeight: 500 }} onClick={(e) => {
            e.preventDefault();
        ...
        >
          ...
          >
            {/* Ambient Shadow layered underneath the dashboard */}
            <div 
              style={{
                position: 'absolute',
                top: '5%',
            ...
            {/* Child Panel for actual dashboard UI */}
            <motion.div
              className="glass cf-hero-dashboard-panel"
              style={{
                transformStyle: 'preserve-3d',
                boxShadow: '0 50px 100px -20px rgba(0, 0, 0, 0.8), 0 30px 60px -30px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.1)',
                overflow: 'hidden',
                borderRadius: '16px',
                border: '1px solid rgba(255,255,255,0.1)'
              }}
            ...
            <div className="cf-hero-workflow-sidebar" style={{ borderRight: '1px solid var(--border)', padding: '34px 28px', position: 'relative' }}>
